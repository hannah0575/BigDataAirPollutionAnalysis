...
(Beast1 <- tSiteList$OZONE)
(Beast2 <- tSiteList$NO2)
(Beast3 <- tSiteList$PM10)
 
data <- c(Beast1, Beast2, Beast3)
...
for (beast in data) {
 ...
 beastoutputs = beast.irreg(log(Y[,1]),time=dates,deltat=1/12, freq=12, tseg.min=3, sseg.min=6)
 plot(beastoutputs)
